...
(function (SereneApp) {
    ...
    })(Administration = SereneApp.Administration || (SereneApp.Administration = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Administration;
...
(function (SereneApp) {
    ...
    })(BasicSamples = SereneApp.BasicSamples || (SereneApp.BasicSamples = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneApp.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SereneApp.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneApp.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SereneApp) {
    ...
    })(Common = SereneApp.Common || (SereneApp.Common = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Common;
...
(function (SereneApp) {
    ...
    })(Membership = SereneApp.Membership || (SereneApp.Membership = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Membership;
...
(function (SereneApp) {
    ...
    })(Northwind = SereneApp.Northwind || (SereneApp.Northwind = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Northwind;
...
(function (SereneApp) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SereneApp.Northwind.Gender', 'SereneApp.Northwind.Entities.Gender');
    })(Northwind = SereneApp.Northwind || (SereneApp.Northwind = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
...
(function (SereneApp) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneApp.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneApp.LanguageList || (SereneApp.LanguageList = {}));
})(SereneApp || (SereneApp = {}));
...
(function (SereneApp) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SereneApp.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SereneApp.ScriptInitialization || (SereneApp.ScriptInitialization = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Administration;
...
(function (SereneApp) {
    ...
    SereneApp.BasicProgressDialog = BasicProgressDialog;
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneApp.BasicProgressDialog();
...
(function (SereneApp) {
    ...
    })(DialogUtils = SereneApp.DialogUtils || (SereneApp.DialogUtils = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Common;
...
(function (SereneApp) {
    ...
    SereneApp.StaticTextBlock = StaticTextBlock;
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneApp.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneApp.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(SereneApp.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SereneApp.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SereneApp.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneApp.Authorization.userDefinition.DisplayName,
...
(function (SereneApp) {
    ...
    (function (Northwind) {
        ...
        }(SereneApp.Common.GridEditorDialog));
...
(function (SereneApp) {
    ...
    (function (Northwind) {
        ...
        }(SereneApp.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return SereneApp.LanguageList.getValue();
            };
...
(function (SereneApp) {
    ...
    })(Authorization = SereneApp.Authorization || (SereneApp.Authorization = {}));
})(SereneApp || (SereneApp = {}));
var SereneApp;
(function (SereneApp) {
    var BasicSamples;
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.ProductDialog));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneApp.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneApp.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneApp.Northwind.OrderDialog();
                        ...
                        var chai = SereneApp.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneApp.Northwind.EmployeeRow.getLookup().items
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.OrderDialog));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SereneApp.Northwind.CategoryService.Retrieve({
        ...
        }(SereneApp.Northwind.CategoryDialog));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SereneApp.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SereneApp.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SereneApp.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SereneApp.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SereneApp.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SereneApp.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneApp.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneApp.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneApp.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneApp.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneApp.Northwind.OrderService.baseUrl; };
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.SupplierDialog));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SereneApp.Northwind.SupplierGrid));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneApp.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneApp.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneApp.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneApp.Northwind.OrderService.baseUrl; };
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneApp.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneApp.Northwind.CustomerDialog));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneApp.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneApp.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SereneApp.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SereneApp.Northwind.OrderDetailDialog));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Northwind.OrderDetailsEditor));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneApp.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneApp.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneApp.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneApp.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneApp.Common.BulkServiceAction));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneApp.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneApp.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneApp.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneApp.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneApp.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneApp.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneApp.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SereneApp) {
    ...
    SereneApp.SelectableEntityGrid = SelectableEntityGrid;
})(SereneApp || (SereneApp = {}));
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SereneApp.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SereneApp.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SereneApp.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SereneApp.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SereneApp.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SereneApp.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneApp.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneApp.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneApp.Northwind.ProductService.baseUrl; };
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SereneApp.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SereneApp.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SereneApp.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SereneApp.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SereneApp) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneApp.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneApp.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneApp.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=SereneApp.Web.js.map